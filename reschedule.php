...
<body>
    ...
    <div class="text-center mb-5">
        ...
        <div class="card-edit shadow-lg border-0 rounded-3 p-4 mx-auto" style="max-width: 500px;">
            ...
            <h2 class="text-center-edit mb-4">Reschedule Appointment</h2>
            <?php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_GET['appointment_id'])) {
        ...
        $update_query = "UPDATE appointments SET appointment_date = '$_POST[appointment_date]', start_time = '$_POST[start_time]', end_time = '$_POST[end_time]' WHERE appointment_id = $appointment_id";
        if ($conn->query($update_query)) {
            echo "<script>window.appointmentDeleted = true;</script>";
            echo "<div class='alert alert-success'>Appointment has been successfully rescheduled.</div>";
            header("refresh:3;url=dashboard.php");
        } else {
            echo "<div class='alert alert-danger'>Failed to reschedule the appointment. Please try again.</div>";
        }
    } else {
        echo "<div class='alert alert-danger'>Appointment ID is missing. Unable to reschedule the appointment.</div>";
    }
}
?>
            <form method="post" class="form-edit">
                ...
                <div class="d-flex justify-content-between mt-4">
                    <button type="submit" id = "confirmButton" class="btn btn-primary">Confirm Reschedule</button>
